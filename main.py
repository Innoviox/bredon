...
board.force_str("a1", BLACK)
board.force_str("d4", WHITE)
board.force_str("d3", WHITE)
board.force_str("b1", BLACK)
board.force_str("d2", WHITE)
board.force_str("d1", BLACK)
input(board)
'''
...
print(board)
input()
ai2 = MinimaxAI(board, WHITE, depth=3)
